...
styles = {500: 'D', 1000: 'o', 2000: 's', 4000: '^'}
colors = {500: 'b', 1000: 'r', 2000: 'g', 4000: 'm'}
...
def draw(N):
    ...
    aa = ax.scatter(Q, s, color=colors[N], marker=styles[N])
    aa.set_label('N={}'.format(N))
...
if __name__ == '__main__':
    ...
    for N in [500, 1000, 2000, 4000]:
        draw(N)
    ax.legend(loc=1, fontsize=axsize * 0.8)
    plt.show()
    # for end in ['pdf', 'eps']:
    #     plt.savefig('/home/tomaszraducha/Pulpit/high_k_cluster_SCALING.{}'.format(end), format=end,
    #                 bbox_inches='tight')
    plt.clf()
